...
const ChoroplethMap = ({ features }) => {
    ...
    const select = ["Youtube登録者数","Youtube最高再生数","Twitterフォロワー数","Twitterツイート数","Twitter開始年月","全国国内線乗降客数","外国人訪問率","芸能人"]
        ...
        <div className="tile is-parent is-vertical">
             <article className="tile is-child notification is-grey has-text-centered">
                 <div>
                     <form onreset = "reset">
                     <label>
                         <input type="checkbox" value="Youtube登録者数" onChange={handleChange} checked={val.includes('Youtube登録者数')}/>
                         Youtube登録者数
                     </label>
                     <label>
                         <input type="checkbox" value="Youtube最高再生数" onChange={handleChange} checked={val.includes('Youtube最高再生数')} />
                         Youtube最高再生数
                     </label>
                     <label>
                         <input type="checkbox" value="Twitterフォロワー数" onChange={handleChange} checked={val.includes('Twitterフォロワー数')} />
                         Twitterフォロワー数
                     </label>
                     <label>
                         <input type="checkbox" value="Twitterツイート数" onChange={handleChange} checked={val.includes('Twitterツイート数')} />
                         Twitterツイート数
                     </label>
                     <label>
                         <input type="checkbox" value="Twitter開始年月" onChange={handleChange} checked={val.includes('Twitter開始年月')} />
                         Twitter開始年月
                     </label>
                     <label>
                         <input type="checkbox" value="全国国内線乗降客数" onChange={handleChange} checked={val.includes('全国国内線乗降客数')} />
                         全国国内線乗降客数
                     </label>
                     <br/>
                     <label>
                         <input type="checkbox" value="外国人訪問率" onChange={handleChange} checked={val.includes('外国人訪問率')} />
                         外国人訪問率
                     </label>
                     <label>
                         <input type="checkbox" value="芸能人" onChange={handleChange} checked={val.includes('芸能人')} />
                         芸能人
                     </label>
                     <p>選択値：{val.join(', ')}</p>
